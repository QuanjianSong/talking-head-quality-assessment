...
from extra_feats.extra_feats import *
...
class newResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000, zero_init_residual=False,
        ...
        # new Model
        self.faceiqa_model = create_metric("topiq_nr-face-custom", device="cuda")
        ...
        # self.quality = self.quality_regression(4096+2048+1024+2048+256+256, 32,1)
        # self.quality = self.quality_regression(4096+2048+1024+2048+256+256, 64,1)
        self.quality = self.quality_regression(4096+2048+1024+2048+256+256, 128,1)
        # self.quality = self.quality_regression(4096+2048+1024+2048+256+256, 256,1)
        # self.quality = self.quality_regression(4096+2048+1024+2048+256+256, 512,1)
        # self.quality = self.quality_regression(4096+2048+1024+2048+256+256, 1024,1)
    ...
    def _forward_impl(self, x, x_3D_features):
        ...
        b,f,c,h,w = x.shape
        feat_in = x.reshape(b*f, c, h, w)
        feat = self.faceiqa_model(feat_in)
        ...
        x = torch.cat((x, x_3D_features, feat), dim = 1)
        # x: batch * frames x 1
        x = self.quality(x)
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000, zero_init_residual=False,
        ...
        # self.quality = self.quality_regression(4096+2048+1024+2048+256, 256,1)
        # self.quality = self.quality_regression(4096+2048+1024+2048+256, 512,1)
        # self.quality = self.quality_regression(4096+2048+1024+2048+256, 1024,1)
        # self.quality = self.quality_regression(4096+2048+1024+2048+256, 2028,1)
